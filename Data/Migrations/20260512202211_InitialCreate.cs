        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackageBuilds_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PackageBuildId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackageComponents_PackageBuilds_PackageBuildId",
                        column: x => x.PackageBuildId,
                        principalTable: "PackageBuilds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageComponents_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageBuilds_UserId",
                table: "PackageBuilds",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageComponents_PackageBuildId",
                table: "PackageComponents",
                column: "PackageBuildId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageComponents_ProductId",
                table: "PackageComponents",
                column: "ProductId");
